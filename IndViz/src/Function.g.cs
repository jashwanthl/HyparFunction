...
namespace IndViz
{
    public class Function
    {
        ...
        private UrlModelStore<IndVizInputs> store;

        public async Task<IndVizOutputs> Handler(IndVizInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<IndVizInputs>();
            }
            

            var l = new InvocationWrapper<IndVizInputs,IndVizOutputs> (store, IndViz.Execute);
